...
const SelectTrigger = React.forwardRef<React.ElementRef<typeof SelectPrimitive.Trigger>, SelectTriggerProps>(
  ({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(componentStyles.select.trigger, className)}
      {...props}
    >
      {children}
  ...
  ({ className, children, position = 'popper', ...props }, ref) => (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ref={ref}
        className={cn(
          componentStyles.select.content,
          position === 'popper' &&
      ...
      >
        ...
        <SelectPrimitive.Viewport className={cn(
          componentStyles.select.viewport,
          position === 'popper' &&
...
const SelectLabel = React.forwardRef<React.ElementRef<typeof SelectPrimitive.Label>, SelectLabelProps>(
  ({ className, ...props }, ref) => (
    <SelectPrimitive.Label
      ref={ref}
      className={cn(componentStyles.select.groupLabel, className)}
      {...props}
    />
  )
)
...
const SelectItem = React.forwardRef<React.ElementRef<typeof SelectPrimitive.Item>, SelectItemProps>(
  ({ className, children, ...props }, ref) => (
    <SelectPrimitive.Item
      ref={ref}
      className={cn(componentStyles.select.item, className)}
      {...props}
    >
      <span className={componentStyles.select.itemIndicator}>
